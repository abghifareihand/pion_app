...
class _FinancialApi implements FinancialApi {
  ...
  Future<HttpResponse<FinancialResponse>> getListFinancial(
    ...
    final _options = _setStreamType<HttpResponse<FinancialResponse>>(
  ...
  Future<HttpResponse<FinancialDetailResponse>> getDetailFinancial(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<FinancialDetailResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/financials/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FinancialDetailResponse _value;
    try {
      _value = FinancialDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
